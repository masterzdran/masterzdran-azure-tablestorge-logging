...
async def azure_storage(mock_table_service, mock_table_client):
    with patch('masterzdran_azure_tablestorage_logging.storage.TableServiceClient.from_connection_string', 
...
async def test_storage_store_log_basic(azure_storage):
    ...
    await storage.store_log(
        ...
        row_key="2024-01-17T12:00:00_INFO",
        data=test_data
    )
